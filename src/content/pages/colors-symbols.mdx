...
figureCaption: A radial histogram illustrates the frequency of specific hues used across global Air Quality Index systems as documented in the AQI Hub. Each segment represents a hue, with length indicating frequency, highlighting common reliance on green, yellow, red, and purple.
---
import { Image } from 'astro:assets';
import HongKong from '@components/HongKongIconsFigure.astro';
import SouthKorea from '@components/SouthKoreaIconsFigure.astro';
