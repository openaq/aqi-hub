...
**Example (PM$_{2.5}$):**  
If daily “Poor” = 16–25 $\mu$g/m$^3$  
→ Hourly “Poor” = 21–35 $\mu$g/m$^3$ (25 × 1.51 ≈ 38)
...
1. For each pollutant, a sub-index value is determined by matching the measured concentration to the corresponding range in the table
    a. This is a direct categorical assignment – for example, if the 8-hour average ozone (O<sub>3</sub>) level is 68 μg/m<sup>3</sup>, it falls in the 61-80 range, which corresponds to an index value of 4 (Fairly Good) 
    b. This process is repeated for all four pollutants (O<sub>3</sub>, NO<sub>2</sub>, SO<sub>2</sub>, PM<sub>10</sub>).
...
[^2]: [https://www.irceline.be/en/air-quality/measurements/belaqi-air-quality-index/information](https://www.irceline.be/en/air-quality/measurements/belaqi-air-quality-index/information)
‌