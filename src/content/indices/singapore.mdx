---
name: Singapore
indexName: Pollution Standards Index
indexAcronym: PSI
---
...
<ColorScale index="singapore" value={false} />
...
<BreakpointsTable index="singapore" />
...
<Admonition type="note">
  The source material does not provide specific guidance on coverage
