...
Determine Concentration Ranges: Each pollutant included in the IQA calculation is associated with defined concentration intervals that correspond to specific air quality 
...
Use the Formula: For each pollutant, the corresponding IQA sub-index is calculated using a standardized piecewise linear formula. This formula interpolates the pollutant concentration 
