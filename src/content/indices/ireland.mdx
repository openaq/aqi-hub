...
PM<sub>2.5</sub> is the most widely monitored pollutant due to its strong link to adverse health effects, while NO<sub>2</sub> is primarily tracked in urban areas 
with heavy traffic.
...
<BreakpointsTable index="ireland" rangeValue={false}/>
...
$$
{AQI} = {Max}({I}_{O_{3}}, {I}_{NO_{2}}, {I}_{SO_{2}}, {I}_{PM_{2.5}}, {I}_{PM_{10}})
$$
</div>
