...
<ColorScale variant="" index="mexico-city" value={true} />
...
<BreakpointsTable variant="" index="mexico-city" />

For each pollutant, the corresponding IMECA sub-index is calculated using a standardized piecewise linear formula. This formula interpolates the pollutant concentration within its applicable range to determine its sub-index value. Apply this formula:
