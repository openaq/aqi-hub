...
At least 75% data availability is needed to compute a valid AQI. At least one PM value (PM2.5 or PM10) is necessary to generate the AQI[^1]. 
...
**Particulate Matter 2.5** (PM<sub>2.5</sub>) (µg/m3) – Averaging Time: 24 hours

| **Concentration** | **Index** | **Formula** |
| ----------------- | --------- | ----------- |
| C ≤ 75 | I ≤ 150 | I = C * 2 |
| C ≤ 150 | I ≤ 200 | I = (C-75) * (⅔) + 150 | 
| C ≤ 250 | I ≤ 300 | I = (C-150) + 200 | 
| C ≤ 400 | I ≤ 500 | I = (C-250) * (4/3) + 300 |
| C > 400 | Beyond AQI |  | 


**Particulate Matter 10** (PM<sub>10</sub>) (µg/m3) – Averaging Time: 24 hours

| **Concentration** | **Index** | **Formula** |
| ----------------- | --------- | ----------- |
| C ≤ 150 | I ≤ 150 | I = C | 
| C ≤ 275 | I ≤ 200 | I = (C-150) * (2/5) + 150 | 
| C ≤ 450 | I ≤ 300 | I = (C-275) * (4/7) + 200 | 
...
| **Concentration** | **Index** | **Formula** |
| ----------------- | --------- | ----------- |
| C ≤ 4500 | I ≤ 100 | I = C * (1/45) | 
| C ≤ 9000 | I ≤ 150 | I = (C-4500) * (1/90) + 100 | 
| C ≤ 15000 | I ≤ 200 | I = (C-9000) * (1/120) + 150 | 
| C ≤ 30000 | I ≤ 300 | I = (C-150000) * (1/150) + 200 | 
| C ≤ 50000 | I ≤ 500 | I = (C-30000) * 0.01 + 300 | 
| C > 50000 | Beyond AQI |  | 
...
| **Concentration** | **Index** | **Formula** |
| ----------------- | --------- | ----------- |
| C ≤ 130 | I ≤ 100 | I = C * (10/13) | 
| C ≤ 350 | I ≤ 150 | I = (C-130) * (5/22) + 100 |
| C ≤ 1250 | I ≤ 300 | I = (C-1250) * (⅙) + 150 | 
| C ≤ 2000 | I ≤ 500 | I = (C-1250) * 0.01 + 300 |
| C > 2000 | Beyond AQI |  | 
...
| **Concentration** | **Index** | **Formula** |
| ----------------- | --------- | ----------- |
| C ≤ 30 | I ≤ 100 | I = C * (10/13) | 
| C ≤ 80 | I ≤ 150 | I = (C-30) + 100 | 
| C ≤ 250 | I ≤ 200 | I = (C-80) * (5/17) + 150 | 
| C ≤ 600 | I ≤ 300 | I = (C-250) * (2/7) + 200 | 
| C ≤ 1000 | I ≤ 500 | I = (C-600) * 0.5 + 300 | 
| C > 1000 | Beyond AQI |  | 


**Example Calculation for PM2.5**

1. Given Data: 
    - Concentration (C): 45 µg/m3
    - Breakpoints: 
        - Low Breakpoint (BPLo): 25 µg/m3 
        - High Breakpoint (BPHi): 50 µg/m3 
...
The sub-AQI for PM2.5 with a concentration of 45 µg/m3 is 90. This means that the air quality for PM2.5 falls into the ‘Moderate’ category based on Sri Lanka’s AQI scale. 
