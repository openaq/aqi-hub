...
Secretariat of Environment) in 2015, used to communicate air pollution levels and their associated health risks in Colombia’s capital. Developed as 
...
(US-EPA) most recent 2018 method, which replaced Colombia’s earlier index based on the 2012 version. Specifically, IBOCA uses the NowCast method for 
...
IBOCA’s methodology was formally updated in Joint Resolution 868 of 2021 and further revised in Joint Resolution 2840 of 2023 [^1]. Its implementation helped 
...
This subcategory exists because the concentration ranges for each IBOCA color do not directly correspond to personal exposure, 
but rather to equivalent levels of excess health risk (ER). For each color category, including 'Dangerous', the lower and upper 
bounds represent pollutant concentrations that result in the same level of ER.: 
...
However, in these cases, only the actual pollutant concentrations (not the index value) will be reported [^2]. 
...
The equation for calculating Bogotá’s AQI (IBOCA) is a piecewise linear function, which is a standard like the U.S. EPA AQI (the IBOCA is modeled after this) 
...
[^1]: [https://www.alcaldiabogota.gov.co/sisjur/normas/Norma1.jsp?i=152203](https://www.alcaldiabogota.gov.co/sisjur/normas/Norma1.jsp?i=152203)
[^2]: [http://iboca.ambientebogota.gov.co/publicaciones/175/que-es-el-iboca/](http://iboca.ambientebogota.gov.co/publicaciones/175/que-es-el-iboca/)
